...
<head>
    ...
    <style>
        ...
        .btn-primary { background-color: var(--color-accent); color: #0f172a; font-weight: 600; padding: 0.5rem 1rem; border-radius: 0.375rem; transition: all 0.2s; }
                    ...
                    <tr class="hover:bg-slate-800/30">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex -space-x-2 overflow-hidden">
                                ...
                                <img class="inline-block h-8 w-8 rounded-full ring-2 ring-slate-900" src="https://i.pravatar.cc/100?img=2" alt=""/>
