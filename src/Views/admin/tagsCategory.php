            ...
            <div class="glass-panel p-6 rounded-xl">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-white mt-1"><?= count($data['Offers']) ?></h3>
                    </div>
            ...
            <div class="glass-panel p-6 rounded-xl">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-white mt-1"><?= count($data['Recruiters']) ?></h3>
                    </div>
            ...
            <div class="glass-panel p-6 rounded-xl">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-white mt-1"><?= count($data['Candidates']) ?></h3>
                    </div>
            ...
            <table class="w-full text-left text-slate-300">
                <thead class="bg-slate-800/50 text-slate-400 text-xs uppercase">
                 ...
                 <?php if (empty($data['Offers'])): ?>
                        <tr>
                            <td colspan="4" class="px-6 py-4 text-center text-slate-500 italic">No job offers posted yet.</td>
                        </tr>
                    <?php else: foreach ($data['Offers'] as $offer): ?>

                <tbody class="divide-y divide-slate-700">
                    <tr class="hover:bg-slate-800/30 transition-colors">
                        <td class="px-6 py-4 font-medium text-white"><?= $offer['title'] ?></td>
